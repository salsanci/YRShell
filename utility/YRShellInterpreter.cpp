...
/*
 ...
 : _cd8 _cd1 _cd4 _cd5 _cd6 _cd7  s' , YRSHELL_DICTIONARY_INTERPRETER_COMPILED);\r\n' .str
 ...
 HELO> : _cd5 s' CompiledDictionary ' .str
 
 HELO> : _cd6 s' interpreterCompiledDictionary( compiledDictionaryData, ' .str
 ...
 HELO> : _cd8 _cd1 _cd4 _cd5 _cd6 _cd7  s' , YRSHELL_DICTIONARY_INTERPRETER_COMPILED);\r\n' .str
 
 HELO> : _cx8 _cx1 _cd4 _cd5 _cx6 _cd7 s' , YRSHELL_DICTIONARY_EXTENSION_COMPILED);\r\n' .str
 
 HELO> : compileInterpreterDictionary _cd8
 ...
 HELO> : _inf0 s'      DICTIONARY_SIZE: ' .str dictionarySize . cr
 : _inf1 s'             PAD_SIZE: ' .str padSize . cr
 : _inf2 s'        NUM_REGISTERS: ' .str numRegisters . cr
 : _inf3 s' PARAMETER_STACK_SIZE: ' .str parameterStackSize . cr
 : _inf4 s'    RETURN_STACK_SIZE: ' .str returnStackSize . cr
 ...
 HELO> : _inf1 s'             PAD_SIZE: ' .str padSize . cr
 
 HELO> : _inf2 s'        NUM_REGISTERS: ' .str numRegisters . cr
 
 HELO> : _inf3 s' PARAMETER_STACK_SIZE: ' .str parameterStackSize . cr
 
 HELO> : _inf4 s'    RETURN_STACK_SIZE: ' .str returnStackSize . cr
 
 HELO> : _inf5 s'   COMPILE_STACK_SIZE: ' .str compileStackSize . cr
 
 HELO> : _inf6 s'             INQ_SIZE: ' .str inqSize . cr
 
 HELO> : _inf7 s'         AUX_INQ_SIZE: ' .str auxInqSize . cr
 
 HELO> : _inf8 s'            OUTQ_SIZE: ' .str outqSize . cr
 
 HELO> : _inf9 s'        AUX_OUTQ_SIZE: ' .str auxOutqSize . cr
 
 HELO> : _infa s'           Shell Size: ' .str shellSize . cr
 
 HELO> : _infb s' Dictionary used free: ' .str dictionarySize getCurrentDictionaryEnd dup . - . cr
 
 HELO> : info printShellClass cr  _inf0 _inf1 _inf2 _inf3 _inf4 _inf5 _inf6 _inf7 _inf8 _inf9 _infa _infb
 
 HELO>compileInterpreterDictionary
 ...
 // 0x00D0
 0x0000 , 0xC009 , 0x0000 , 0xE0BD , 0xC01E , 0xC044 , 0xC011 , 0xC016 , 0x202C , 0x0000 , 0xC012 , 0xC009 , 0x0001 , 0xC027 , 0xC01E , 0xC045 ,
 // 0x00E0
 0xC033 , 0xC01D , 0xE0D3 , 0xC022 , 0xC001 , 0x00CD , 0x635F , 0x3464 , 0x0000 , 0xC045 , 0xC03F , 0xC01D , 0xE0EF , 0xE0D1 , 0xC005 , 0xC016 ,
 // 0x00F0
 0x3B7D , 0x0A0D , 0x0000 , 0xC012 , 0xC001 , 0x00E5 , 0x635F , 0x3564 , 0x0000 , 0xC016 , 0x6F43 , 0x706D , 0x6C69 , 0x6465 , 0x6944 , 0x7463 ,
 // 0x0100
 0x6F69 , 0x616E , 0x7972 , 0x0020 , 0xC012 , 0xC001 , 0x00F5 , 0x635F , 0x3664 , 0x0000 , 0xC016 , 0x6E69 , 0x6574 , 0x7072 , 0x6572 , 0x6574 ,
 // 0x0110
 0x4372 , 0x6D6F , 0x6970 , 0x656C , 0x4464 , 0x6369 , 0x6974 , 0x6E6F , 0x7261 , 0x2879 , 0x6320 , 0x6D6F , 0x6970 , 0x656C , 0x4464 , 0x6369 ,
 // 0x0120
 0x6974 , 0x6E6F , 0x7261 , 0x4479 , 0x7461 , 0x2C61 , 0x0020 , 0xC012 , 0xC001 , 0x0106 , 0x635F , 0x3678 , 0x0000 , 0xC016 , 0x6F63 , 0x706D ,
 // 0x0130
 0x6C69 , 0x6465 , 0x7845 , 0x6574 , 0x736E , 0x6F69 , 0x446E , 0x6369 , 0x6974 , 0x6E6F , 0x7261 , 0x2879 , 0x6320 , 0x6D6F , 0x6970 , 0x656C ,
 // 0x0140
 0x4564 , 0x7478 , 0x6E65 , 0x6973 , 0x6E6F , 0x6944 , 0x7463 , 0x6F69 , 0x616E , 0x7972 , 0x6144 , 0x6174 , 0x202C , 0x0000 , 0xC012 , 0xC001 ,
 // 0x0150
 0x0129 , 0x635F , 0x3764 , 0x0000 , 0xC046 , 0xC011 , 0xC016 , 0x202C , 0x0000 , 0xC012 , 0xC045 , 0xC011 , 0xC001 , 0x0150 , 0x635F , 0x3864 ,
 // 0x0160
 0x0000 , 0xE089 , 0xE0E9 , 0xE0F9 , 0xE10A , 0xE154 , 0xC016 , 0x202C , 0x5259 , 0x4853 , 0x4C45 , 0x5F4C , 0x4944 , 0x5443 , 0x4F49 , 0x414E ,
 // 0x0170
 0x5952 , 0x495F , 0x544E , 0x5245 , 0x5250 , 0x5445 , 0x5245 , 0x435F , 0x4D4F , 0x4950 , 0x454C , 0x2944 , 0x0D3B , 0x000A , 0xC012 , 0xC001 ,
 // 0x0180
 0x015D , 0x635F , 0x3878 , 0x0000 , 0xE0A1 , 0xE0E9 , 0xE0F9 , 0xE12D , 0xE154 , 0xC016 , 0x202C , 0x5259 , 0x4853 , 0x4C45 , 0x5F4C , 0x4944 ,
 // 0x0190
 0x5443 , 0x4F49 , 0x414E , 0x5952 , 0x455F , 0x5458 , 0x4E45 , 0x4953 , 0x4E4F , 0x435F , 0x4D4F , 0x4950 , 0x454C , 0x2944 , 0x0D3B , 0x000A ,
 // 0x01A0
 0xC012 , 0xC001 , 0x0180 , 0x6F63 , 0x706D , 0x6C69 , 0x4965 , 0x746E , 0x7265 , 0x7270 , 0x7465 , 0x7265 , 0x6944 , 0x7463 , 0x6F69 , 0x616E ,
 // 0x01B0
 0x7972 , 0x0000 , 0xE161 , 0xC001 , 0x01A2 , 0x6F63 , 0x706D , 0x6C69 , 0x4565 , 0x7478 , 0x6E65 , 0x6973 , 0x6E6F , 0x6944 , 0x7463 , 0x6F69 ,
 // 0x01C0
 0x616E , 0x7972 , 0x0000 , 0xE184 , 0xC001 , 0x01B4 , 0x6964 , 0x7463 , 0x6E49 , 0x6176 , 0x696C , 0x0064 , 0xC009 , 0xFFFF , 0xC001 , 0x01C5 ,
 // 0x01D0
 0x6C77 , 0x005F , 0xC023 , 0xC01E , 0xC01D , 0xE1D7 , 0xC005 , 0xC03E , 0xC023 , 0xC023 , 0xC001 , 0x01CF , 0x6C77 , 0x0000 , 0xC009 , 0x0000 ,
 // 0x01E0
 0xC009 , 0x0000 , 0xE1CC , 0xC048 , 0xC040 , 0xC010 , 0xC01E , 0xC011 , 0xC041 , 0xC04A , 0xC011 , 0xC041 , 0xC049 , 0xE1D2 , 0xC01E , 0xE1CC ,
 // 0x01F0
 0xC031 , 0xC01D , 0xE1E3 , 0xC042 , 0xC022 , 0xC001 , 0x01DB , 0x695F , 0x666E , 0x0030 , 0xC016 , 0x2020 , 0x2020 , 0x4420 , 0x4349 , 0x4954 ,
 // 0x0200
 0x4E4F , 0x5241 , 0x5F59 , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 , 0xC053 , 0xC00C , 0xC003 , 0xC001 , 0x01F6 , 0x695F , 0x666E , 0x0031 ,
 // 0x0210
 0xC016 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x4150 , 0x5F44 , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 , 0xC054 , 0xC00C ,
 // 0x0220
 0xC003 , 0xC001 , 0x020C , 0x695F , 0x666E , 0x0032 , 0xC016 , 0x2020 , 0x2020 , 0x2020 , 0x4E20 , 0x4D55 , 0x525F , 0x4745 , 0x5349 , 0x4554 ,
 // 0x0230
 0x5352 , 0x203A , 0x0000 , 0xC012 , 0xC055 , 0xC00C , 0xC003 , 0xC001 , 0x0222 , 0x695F , 0x666E , 0x0033 , 0xC016 , 0x4150 , 0x4152 , 0x454D ,
 // 0x0240
 0x4554 , 0x5F52 , 0x5453 , 0x4341 , 0x5F4B , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 , 0xC056 , 0xC00C , 0xC003 , 0xC001 , 0x0238 , 0x695F ,
 // 0x0250
 0x666E , 0x0034 , 0xC016 , 0x2020 , 0x5220 , 0x5445 , 0x5255 , 0x5F4E , 0x5453 , 0x4341 , 0x5F4B , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 ,
 // 0x0260
 0xC057 , 0xC00C , 0xC003 , 0xC001 , 0x024E , 0x695F , 0x666E , 0x0035 , 0xC016 , 0x2020 , 0x4F43 , 0x504D , 0x4C49 , 0x5F45 , 0x5453 , 0x4341 ,
 // 0x0270
 0x5F4B , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 , 0xC058 , 0xC00C , 0xC003 , 0xC001 , 0x0264 , 0x695F , 0x666E , 0x0036 , 0xC016 , 0x2020 ,
 // 0x0280
 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x4E49 , 0x5F51 , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 , 0xC059 , 0xC00C , 0xC003 , 0xC001 ,
 // 0x0290
 0x027A , 0x695F , 0x666E , 0x0037 , 0xC016 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x5541 , 0x5F58 , 0x4E49 , 0x5F51 , 0x4953 , 0x455A , 0x203A ,
 // 0x02A0
 0x0000 , 0xC012 , 0xC05A , 0xC00C , 0xC003 , 0xC001 , 0x0290 , 0x695F , 0x666E , 0x0038 , 0xC016 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x2020 ,
 // 0x02B0
 0x4F20 , 0x5455 , 0x5F51 , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 , 0xC05B , 0xC00C , 0xC003 , 0xC001 , 0x02A6 , 0x695F , 0x666E , 0x0039 ,
 // 0x02C0
 0xC016 , 0x2020 , 0x2020 , 0x2020 , 0x4120 , 0x5855 , 0x4F5F , 0x5455 , 0x5F51 , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 , 0xC05C , 0xC00C ,
 // 0x02D0
 0xC003 , 0xC001 , 0x02BC , 0x695F , 0x666E , 0x0061 , 0xC016 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x6853 , 0x6C65 , 0x206C , 0x6953 ,
 // 0x02E0
 0x657A , 0x203A , 0x0000 , 0xC012 , 0xC051 , 0xC00C , 0xC003 , 0xC001 , 0x02D2 , 0x695F , 0x666E , 0x0062 , 0xC016 , 0x6944 , 0x7463 , 0x6F69 ,
 // 0x02F0
 0x616E , 0x7972 , 0x7520 , 0x6573 , 0x2064 , 0x7266 , 0x6565 , 0x203A , 0x0000 , 0xC012 , 0xC053 , 0xC045 , 0xC01E , 0xC00C , 0xC028 , 0xC00C ,
 // 0x0300
 0xC003 , 0xC001 , 0x02E8 , 0x6E69 , 0x6F66 , 0x0000 , 0xC052 , 0xC003 , 0xE1FA , 0xE210 , 0xE226 , 0xE23C , 0xE252 , 0xE268 , 0xE27E , 0xE294 ,
 // 0x0310
 0xE2AA , 0xE2C0 , 0xE2D6 , 0xE2EC , 0xC001 ,
 };
 CompiledDictionary interpreterCompiledDictionary( compiledDictionaryData, 0x0302 , 0x0315 , YRSHELL_DICTIONARY_INTERPRETER_COMPILED);
