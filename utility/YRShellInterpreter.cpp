...
YRShell Version 0.1
fOK> : ps? s' PARAMETER STACK: ' .str psd? 0!= [ psd? { dup ps@ . 1 - dup 0== } drop ] cr
fOK> : rs? s'    RETURN STACK: ' .str rsd? 0!= [ rsd? 1 - { dup rs@ . 1 - dup -1 == } drop ] cr
fOK> : cs? s'   COMPILE STACK: ' .str csd? 0!= [ csd? 1 - { dup cs@ . 1 - dup -1 == } drop ] cr
fOK> : st? ps? rs? cs?
fOK> : _cd0 s' \rstatic uint16_t ' .str
fOK> : _cd1 _cd0 s' compiledDictionaryData[] = {\r' .str
fOK> : _cx1 _cd0 s' compiledExtensionDictionaryData[] = {\r' .str
fOK> : _cd2 dup 0xF & 0== [ cr s' // ' .str dup .wx cr ]
fOK> : _cd3 0 { _cd2 dup getCurrentDictionary .wx s' , ' .str 1 + dup getCurrentDictionaryEnd >= } drop
fOK> : _cd4 getCurrentDictionaryEnd 0!= [ _cd3 crlf ] s' };\r' .str
fOK> : _cd5 s' CompiledDictionary ' .str
fOK> : _cd6 s' interpreterCompiledDictionary( compiledDictionaryData, ' .str
fOK> : _cx6 s' compiledExtensionDictionary( compiledExtensionDictionaryData, ' .str
fOK> : _cd7 getCurrentDictionaryLastWord .wx s' , ' .str getCurrentDictionaryEnd .wx
fOK> : _cd8 _cd1 _cd4 _cd5 _cd6 _cd7  s' , YRSHELL_DICTIONARY_INTERPRETER_COMPILED);\r' .str
fOK> : _cx8 _cx1 _cd4 _cd5 _cx6 _cd7 s' , YRSHELL_DICTIONARY_EXTENSION_COMPILED);\r' .str
fOK> : compileInterpreterDictionary _cd8
fOK> : compileExtensionDictionary _cx8
fOK> : dictInvalid 0xFFFF
fOK> : wl_ rot dup [ cr ] 0== rot rot
fOK> : wl 0 0 dictInvalid { nextEntry over .bx dup .wx 2dup entryToken .wx 2dup .entryName wl_ dup dictInvalid == } 2drop drop
fOK> : _inf0 s'      DICTIONARY_SIZE: ' .str dictionarySize . cr
fOK> : _inf1 s'             PAD_SIZE: ' .str padSize . cr
fOK> : _inf2 s'        NUM_REGISTERS: ' .str numRegisters . cr
fOK> : _inf3 s' PARAMETER_STACK_SIZE: ' .str parameterStackSize . cr
fOK> : _inf4 s'    RETURN_STACK_SIZE: ' .str returnStackSize . cr
fOK> : _inf5 s'   COMPILE_STACK_SIZE: ' .str compileStackSize . cr
fOK> : _inf6 s'             INQ_SIZE: ' .str inqSize . cr
fOK> : _inf7 s'         AUX_INQ_SIZE: ' .str auxInqSize . cr
fOK> : _inf8 s'            OUTQ_SIZE: ' .str outqSize . cr
fOK> : _inf9 s'        AUX_OUTQ_SIZE: ' .str auxOutqSize . cr
fOK> : _infa s'           Shell Size: ' .str shellSize . cr
fOK> : _infb s' Dictionary used free: ' .str dictionarySize getCurrentDictionaryEnd dup . - . cr
fOK> : info printShellClass cr  _inf0 _inf1 _inf2 _inf3 _inf4 _inf5 _inf6 _inf7 _inf8 _inf9 _infa _infb
fOK>compileInterpreterDictionary
...
// 0x01C0 
0x6964 , 0x7463 , 0x6E49 , 0x6176 , 0x696C , 0x0064 , 0xC009 , 0xFFFF , 0xC001 , 0x01BF , 0x6C77 , 0x005F , 0xC023 , 0xC01E , 0xC01D , 0xE1D1 , 
// 0x01D0 
0xC003 , 0xC03E , 0xC023 , 0xC023 , 0xC001 , 0x01C9 , 0x6C77 , 0x0000 , 0xC009 , 0x0000 , 0xC009 , 0x0000 , 0xE1C6 , 0xC048 , 0xC040 , 0xC010 , 
// 0x01E0 
0xC01E , 0xC011 , 0xC041 , 0xC04A , 0xC011 , 0xC041 , 0xC049 , 0xE1CC , 0xC01E , 0xE1C6 , 0xC031 , 0xC01D , 0xE1DD , 0xC042 , 0xC022 , 0xC001 , 
// 0x01F0 
0x01D5 , 0x695F , 0x666E , 0x0030 , 0xC016 , 0x2020 , 0x2020 , 0x4420 , 0x4349 , 0x4954 , 0x4E4F , 0x5241 , 0x5F59 , 0x4953 , 0x455A , 0x203A , 
// 0x0200 
0x0000 , 0xC012 , 0xC053 , 0xC00C , 0xC003 , 0xC001 , 0x01F0 , 0x695F , 0x666E , 0x0031 , 0xC016 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 
// 0x0210 
0x2020 , 0x4150 , 0x5F44 , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 , 0xC054 , 0xC00C , 0xC003 , 0xC001 , 0x0206 , 0x695F , 0x666E , 0x0032 , 
// 0x0220 
0xC016 , 0x2020 , 0x2020 , 0x2020 , 0x4E20 , 0x4D55 , 0x525F , 0x4745 , 0x5349 , 0x4554 , 0x5352 , 0x203A , 0x0000 , 0xC012 , 0xC055 , 0xC00C , 
// 0x0230 
0xC003 , 0xC001 , 0x021C , 0x695F , 0x666E , 0x0033 , 0xC016 , 0x4150 , 0x4152 , 0x454D , 0x4554 , 0x5F52 , 0x5453 , 0x4341 , 0x5F4B , 0x4953 , 
// 0x0240 
0x455A , 0x203A , 0x0000 , 0xC012 , 0xC056 , 0xC00C , 0xC003 , 0xC001 , 0x0232 , 0x695F , 0x666E , 0x0034 , 0xC016 , 0x2020 , 0x5220 , 0x5445 , 
// 0x0250 
0x5255 , 0x5F4E , 0x5453 , 0x4341 , 0x5F4B , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 , 0xC057 , 0xC00C , 0xC003 , 0xC001 , 0x0248 , 0x695F , 
// 0x0260 
0x666E , 0x0035 , 0xC016 , 0x2020 , 0x4F43 , 0x504D , 0x4C49 , 0x5F45 , 0x5453 , 0x4341 , 0x5F4B , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 , 
// 0x0270 
0xC058 , 0xC00C , 0xC003 , 0xC001 , 0x025E , 0x695F , 0x666E , 0x0036 , 0xC016 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x4E49 , 
// 0x0280 
0x5F51 , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 , 0xC059 , 0xC00C , 0xC003 , 0xC001 , 0x0274 , 0x695F , 0x666E , 0x0037 , 0xC016 , 0x2020 , 
// 0x0290 
0x2020 , 0x2020 , 0x2020 , 0x5541 , 0x5F58 , 0x4E49 , 0x5F51 , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 , 0xC05A , 0xC00C , 0xC003 , 0xC001 , 
// 0x02A0 
0x028A , 0x695F , 0x666E , 0x0038 , 0xC016 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x4F20 , 0x5455 , 0x5F51 , 0x4953 , 0x455A , 0x203A , 
// 0x02B0 
0x0000 , 0xC012 , 0xC05B , 0xC00C , 0xC003 , 0xC001 , 0x02A0 , 0x695F , 0x666E , 0x0039 , 0xC016 , 0x2020 , 0x2020 , 0x2020 , 0x4120 , 0x5855 , 
// 0x02C0 
0x4F5F , 0x5455 , 0x5F51 , 0x4953 , 0x455A , 0x203A , 0x0000 , 0xC012 , 0xC05C , 0xC00C , 0xC003 , 0xC001 , 0x02B6 , 0x695F , 0x666E , 0x0061 , 
// 0x02D0 
0xC016 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x2020 , 0x6853 , 0x6C65 , 0x206C , 0x6953 , 0x657A , 0x203A , 0x0000 , 0xC012 , 0xC051 , 0xC00C , 
// 0x02E0 
0xC003 , 0xC001 , 0x02CC , 0x695F , 0x666E , 0x0062 , 0xC016 , 0x6944 , 0x7463 , 0x6F69 , 0x616E , 0x7972 , 0x7520 , 0x6573 , 0x2064 , 0x7266 , 
// 0x02F0 
0x6565 , 0x203A , 0x0000 , 0xC012 , 0xC053 , 0xC045 , 0xC01E , 0xC00C , 0xC028 , 0xC00C , 0xC003 , 0xC001 , 0x02E2 , 0x6E69 , 0x6F66 , 0x0000 , 
// 0x0300 
0xC052 , 0xC003 , 0xE1F4 , 0xE20A , 0xE220 , 0xE236 , 0xE24C , 0xE262 , 0xE278 , 0xE28E , 0xE2A4 , 0xE2BA , 0xE2D0 , 0xE2E6 , 0xC001 , 

};
CompiledDictionary interpreterCompiledDictionary( compiledDictionaryData, 0x02FC , 0x030F , YRSHELL_DICTIONARY_INTERPRETER_COMPILED);
fOK>
